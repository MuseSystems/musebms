defmodule MsappPlatformWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MsappPlatformWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MsappPlatformWeb.Gettext, "errors", msg, opts)
    end
  end
