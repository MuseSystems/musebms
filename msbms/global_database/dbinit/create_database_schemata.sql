...
SET SESSION AUTHORIZATION msbms_sys_owner;
SET SESSION ROLE msbms_sys_owner;

CREATE SCHEMA IF NOT EXISTS msbms_syst
    AUTHORIZATION msbms_sys_owner;

REVOKE USAGE ON SCHEMA msbms_syst FROM PUBLIC;
GRANT USAGE ON SCHEMA msbms_syst TO msbms_sys_app_admin;
GRANT USAGE ON SCHEMA msbms_syst TO msbms_sys_api_admin;
GRANT USAGE ON SCHEMA msbms_syst TO msbms_sys_app_user;
GRANT USAGE ON SCHEMA msbms_syst TO msbms_sys_api_user;
...
REVOKE USAGE ON SCHEMA msbms_syst_priv FROM msbms_sys_app_admin;
REVOKE USAGE ON SCHEMA msbms_syst_priv FROM msbms_sys_api_admin;
REVOKE USAGE ON SCHEMA msbms_syst_priv FROM msbms_sys_app_user;
REVOKE USAGE ON SCHEMA msbms_syst_priv FROM msbms_sys_api_user;
...
REVOKE USAGE ON SCHEMA msbms_syst_data FROM msbms_sys_app_admin;
REVOKE USAGE ON SCHEMA msbms_syst_data FROM msbms_sys_api_admin;
REVOKE USAGE ON SCHEMA msbms_syst_data FROM msbms_sys_app_user;
REVOKE USAGE ON SCHEMA msbms_syst_data FROM msbms_sys_api_user;
