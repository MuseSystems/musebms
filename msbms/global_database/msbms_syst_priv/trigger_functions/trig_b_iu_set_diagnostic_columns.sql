...
-- Source File: trig_b_iu_set_diagnostic_columns.sql
-- Location:    msbms/global_database/msbms_syst_priv/trigger_functions/trig_b_iu_set_diagnostic_columns.sql
-- Project:     musebms
--
...
ALTER FUNCTION msbms_syst_priv.trig_b_iu_set_diagnostic_columns()
    OWNER TO msbms_sys_owner;

REVOKE EXECUTE ON FUNCTION msbms_syst_priv.trig_b_iu_set_diagnostic_columns() FROM public;
GRANT EXECUTE ON FUNCTION msbms_syst_priv.trig_b_iu_set_diagnostic_columns() TO msbms_sys_owner;
