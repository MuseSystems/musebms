...
COMMENT ON
    COLUMN msbms_syst_data.enum_types.app_relation_id IS
...
COMMENT ON
    COLUMN msbms_syst_data.enum_types.internal_name IS
...
COMMENT ON
    COLUMN msbms_syst_data.enum_types.display_name IS
