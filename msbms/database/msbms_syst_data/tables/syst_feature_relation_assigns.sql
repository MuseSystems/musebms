-- File:        syst_feature_relation_assigns.sql
-- Location:    msbms/database/msbms_syst_data/tables/syst_feature_relation_assigns.sql
...
COMMENT ON
    COLUMN msbms_syst_data.syst_feature_relation_assigns.app_relation_id IS
