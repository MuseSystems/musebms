-- Source File: mstr_entity_inventory_places.sql
-- Location:    msbms/database/instance/msbms_appl_data/tables/mstr_entity_inventory_places.sql
-- Project:     musebms
--
...
(
    ...
    ,owning_entity_id               uuid                                    NOT NULL
        ...
        ON DELETE CASCADE
    ,receives_external_inventory    boolean     DEFAULT false               NOT NULL
    ,fulfills_external_inventory    boolean     DEFAULT false               NOT NULL
    ,receives_internal_inventory    boolean     DEFAULT false               NOT NULL
    ,fulfills_internal_inventory    boolean     DEFAULT false               NOT NULL
