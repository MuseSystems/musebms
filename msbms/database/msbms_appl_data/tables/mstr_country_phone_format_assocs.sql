-- File:        mstr_country_phone_format_assocs.sql
-- Location:    msbms/database/msbms_appl_data/tables/mstr_country_phone_format_assocs.sql
-- Project:     musebms
--
...
(
    ...
    ,phone_format_id       uuid                                    NOT NULL
        ...
        REFERENCES msbms_appl_data.mstr_phone_formats (id)
