...
-- Source File: enum_instance_types.sql
-- Location:    msbms/global_database/msbms_syst_data/tables/enum_instance_types.sql
-- Project:     musebms
--
...
ALTER TABLE msbms_syst_data.enum_instance_types OWNER TO msbms_sys_owner;

REVOKE ALL ON TABLE msbms_syst_data.enum_instance_types FROM public;
GRANT ALL ON TABLE msbms_syst_data.enum_instance_types TO msbms_sys_owner;
