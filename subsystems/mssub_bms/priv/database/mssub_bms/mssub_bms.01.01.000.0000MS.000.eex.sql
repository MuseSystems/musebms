-- Migration: priv/database/mssub_bms/mssub_bms.01.01.000.0000MS.000.eex.sql
-- Built on:  2022-12-02 00:38:01.628478Z
...
-- Location:    musebms/database/components/application/mscmp_brm_country/ms_appl_data/mstr_country_address_format_assocs/mstr_country_address_format_assocs.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
...
-- Location:    musebms/database/components/application/mscmp_brm_entity/seed_data/initialize_enum_entity_states.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
...
-- Location:    musebms/database/components/application/mscmp_brm_place/seed_data/initialize_enum_place_states.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
...
-- Location:    musebms/database/components/application/mscmp_brm_contact/seed_data/initialize_enum_contact_states.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
...
updates can be found.  This row starts at 0 and therefore may be the same as the
diag_row_version - 1.$DOC$;
-- File:        mstr_entity_staff_entities.eex.sql
-- Location:    musebms/database/components/application/mscmp_brm_entity_staff/ms_appl_data/mstr_entity_staff_entities/mstr_entity_staff_entities.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
...
CREATE TABLE ms_appl_data.mstr_entity_staff_entities
(
     id
        uuid
        NOT NULL DEFAULT uuid_generate_v1( )
        CONSTRAINT mstr_entity_staff_entities_pk PRIMARY KEY
    ,entity_id
        uuid
        NOT NULL
        CONSTRAINT mstr_entity_staff_entities_entity_fk
            REFERENCES ms_appl_data.mstr_entities (id) ON DELETE CASCADE
    ,owning_entity_id
        uuid
        NOT NULL
        CONSTRAINT mstr_entity_staff_entities_owning_entity_fk
            REFERENCES ms_appl_data.mstr_entities (id) ON DELETE CASCADE
    ,diag_timestamp_created
        timestamptz
        NOT NULL DEFAULT now( )
    ...
    ,diag_update_count
        bigint
        NOT NULL DEFAULT 0
    ,CONSTRAINT mstr_entity_staff_entities_udx
        UNIQUE (entity_id, owning_entity_id)
);

ALTER TABLE ms_appl_data.mstr_entity_staff_entities OWNER TO <%= ms_owner %>;

REVOKE ALL ON TABLE ms_appl_data.mstr_entity_staff_entities FROM public;
GRANT ALL ON TABLE ms_appl_data.mstr_entity_staff_entities TO <%= ms_owner %>;

CREATE TRIGGER z99_trig_b_iu_set_diagnostic_columns
    BEFORE INSERT OR UPDATE ON ms_appl_data.mstr_entity_staff_entities
    FOR EACH ROW EXECUTE PROCEDURE ms_syst_priv.trig_b_iu_set_diagnostic_columns();

COMMENT ON
    TABLE ms_appl_data.mstr_entity_staff_entities IS
...
COMMENT ON
    COLUMN ms_appl_data.mstr_entity_staff_entities.id IS
$DOC$The record's primary key.  The definitive identifier of the record in the
system.$DOC$;

COMMENT ON
    COLUMN ms_appl_data.mstr_entity_staff_entities.entity_id IS
$DOC$Identifies for which entity customer details are being defined.  The terms
in this record define the customer behavior for the entity defined by this
field.$DOC$;

COMMENT ON
    COLUMN ms_appl_data.mstr_entity_staff_entities.owning_entity_id IS
$DOC$Identifies the entity that will use the customer terms when processing
selling and receivables transactions with the entity identified in the
entity_id field.$DOC$;

COMMENT ON
    COLUMN ms_appl_data.mstr_entity_staff_entities.diag_timestamp_created IS
$DOC$The database server date/time when the transaction which created the record
started.$DOC$;

COMMENT ON
    COLUMN ms_appl_data.mstr_entity_staff_entities.diag_role_created IS
$DOC$The database role which created the record.$DOC$;

COMMENT ON
    COLUMN ms_appl_data.mstr_entity_staff_entities.diag_timestamp_modified IS
$DOC$The database server date/time when the transaction which modified the record
started.  This field will be the same as diag_timestamp_created for inserted
records.$DOC$;

COMMENT ON
    COLUMN ms_appl_data.mstr_entity_staff_entities.diag_wallclock_modified IS
$DOC$The database server date/time at the moment the record was actually modified.
For long running transactions this time may be significantly later than the
value of diag_timestamp_modified.$DOC$;

COMMENT ON
    COLUMN ms_appl_data.mstr_entity_staff_entities.diag_role_modified IS
$DOC$The database role which modified the record.$DOC$;

COMMENT ON
    COLUMN ms_appl_data.mstr_entity_staff_entities.diag_row_version IS
$DOC$The current version of the row.  The value here indicates how many actual
data changes have been made to the row.  If an update of the row leaves all data
fields the same, disregarding the updates to the diag_* columns, the row version
is not updated, nor are any updates made to the other diag_* columns other than
...
COMMENT ON
    COLUMN ms_appl_data.mstr_entity_staff_entities.diag_update_count IS
$DOC$Records the number of times the record has been updated regardless as to if
the update actually changed any data.  In this way needless or redundant record
updates can be found.  This row starts at 0 and therefore may be the same as the
diag_row_version - 1.$DOC$;
...
updates can be found.  This row starts at 0 and therefore may be the same as the
diag_row_version - 1.$DOC$;
-- File:        initialize_enum_entity_facility_roles.eex.sql
-- Location:    musebms/database/components/application/mscmp_brm_entity_facility/seed_data/initialize_enum_entity_facility_roles.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
...
-- Location:    musebms/database/components/application/mscmp_brm_entity_person/seed_data/initialize_enum_entity_person_roles.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
...
-- Location:    musebms/database/components/application/mscmp_syst_interactions/ms_syst_data/syst_person_logins/syst_person_logins.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
...
-- Location:    musebms/database/components/application/mscmp_acc_calendar/seed_data/initialize_enum_fiscal_period_states.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
...
-- Location:    musebms/database/components/application/mscmp_acc_calendar/seed_data/initialize_enum_fiscal_year_types.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
