...
# Location:    musebms/app_server/components/system/mscmp_syst_session/test/support/test_support.ex
...
defmodule TestSupport do
  ...
  def setup_testing_database(test_kind, opts) do
    ...
    MscmpSystDb.Datastore.child_spec(datastore_options,
      context_registry: opts[:context_registry] || MscmpSystSession.TestRegistry
    )
  end
