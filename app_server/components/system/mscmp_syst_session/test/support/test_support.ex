...
# Location:    musebms/components/system/mscmp_syst_session/test/support/test_support.ex
  ...
  @datastore_options %{
    ...
    contexts: [
      ...
      %{
        ...
        database_password: "mscmp_syst_session.testing.code.app.user",
    ...
    db_server: %{
      ...
      db_max_instances: 1,
      server_pools: [],
      server_salt: "mscmp_syst_session.testing.code.test.salt",
  ...
  def setup_testing_database(test_kind) do
    ...
    {:ok, _} =
      MscmpSystDb.upgrade_datastore(
        ...
        ms_appusr: "mscmp_syst_session_app_user"
      )
