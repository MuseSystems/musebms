...
# Location:    musebms/app_server/components/system/mscmp_syst_session/test/test_helper.exs
...
test_registry = MscmpSystSession.TestRegistry
...
{:ok, _pid} =
  Supervisor.start_link(children,
    ...
    name: :"MscmpSystSession.TestSupportSupervisor"
  )
