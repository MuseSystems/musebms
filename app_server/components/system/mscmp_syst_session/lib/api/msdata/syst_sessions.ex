...
# Location:    musebms/app_server/components/system/mscmp_syst_session/lib/api/msdata/syst_sessions.ex
...
defmodule Msdata.SystSessions do
  ...
  alias MscmpSystSession.Impl.Msdata.SystSessions.Validators
