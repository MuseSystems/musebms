...
# Location:    musebms/app_server/components/system/mscmp_syst_session/dev_support/dev_support.ex
...
defmodule DevSupport do
  ...
  @registry :"MscmpSystSession.DevSupportRegistry"
     ...
     children =
      ...
      {:ok, _pid} =
        Supervisor.start_link(
          children, strategy: :one_for_one, name: :"MscmpSystSession.DevSupportSupervisor")
  ...
  def stop_dev_environment do
    _ = cleanup_database()
    Supervisor.stop(:"MscmpSystSession.DevSupportSupervisor")
  end
