...
# Location:    musebms/app_server/components/system/mscmp_syst_menu/test/support/test_support.ex
...
defmodule TestSupport do
  ...
  @datastore_options %DatastoreOptions{
    database_name: "mscmp_syst_menu",
    datastore_code: "mscmp_syst_menu.testing.code",
    datastore_name: :mscmp_syst_menu,
    contexts: [
      %DatastoreContext{
        context_name: nil,
        description: "MscmpSystMenu Testing Owner",
        database_role: "mscmp_syst_menu_owner",
      ...
      %DatastoreContext{
        ...
        description: "MscmpSystMenu Testing App User",
        database_role: "mscmp_syst_menu_app_user",
        database_password: "mscmp_syst_menu.testing.code.app.user",
    ...
    db_server: %DbServer{
      ...
      db_max_instances: 1,
      server_salt: "mscmp_syst_menu.testing.code.test.salt",
  ...
  @migration_integration_test_ds_type "mscmp_syst_menu_integration_test"
  @migration_doc_test_ds_type "mscmp_syst_menu_doc_test"
  ...
  def setup_testing_database(test_kind) do
    ...
    {:ok, _} =
      MscmpSystDb.upgrade_datastore(
        ...
        ms_appusr: "mscmp_syst_menu_app_user"
      )
