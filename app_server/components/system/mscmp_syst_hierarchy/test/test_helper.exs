...
children = [
  {DynamicSupervisor, strategy: :one_for_one, name: MscmpSystHierarchy.TestingSupervisor}
]

Supervisor.start_link(children, strategy: :one_for_one)

enum_service_spec = %{
  id: MscmpSystHierarchyTestingEnumService,
  start: {
    MscmpSystEnums,
    :start_link,
...
DynamicSupervisor.start_child(MscmpSystHierarchy.TestingSupervisor, enum_service_spec)
