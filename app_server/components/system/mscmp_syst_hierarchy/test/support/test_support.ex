...
# Location:    musebms/app_server/components/system/mscmp_syst_hierarchy/test/support/test_support.ex
...
defmodule TestSupport do
  ...
  @datastore_options %DatastoreOptions{
    database_name: "mscmp_syst_hierarchy",
    datastore_code: "mscmp_syst_hierarchy.testing.code",
    datastore_name: :mscmp_syst_hierarchy,
    contexts: [
      %DatastoreContext{
        context_name: nil,
        description: "MscmpSystHierarchy Testing Owner",
        database_role: "mscmp_syst_hierarchy_owner",
      ...
      %DatastoreContext{
        ...
        description: "MscmpSystHierarchy Testing App User",
        database_role: "mscmp_syst_hierarchy_app_user",
        database_password: "mscmp_syst_hierarchy.testing.code.app.user",
    ...
    db_server: %DbServer{
      ...
      db_max_instances: 1,
      server_salt: "mscmp_syst_hierarchy.testing.code.test.salt",
  ...
  def setup_testing_database(test_kind) do
    ...
    {:ok, _} =
      MscmpSystDb.upgrade_datastore(
        ...
        ms_appusr: "mscmp_syst_hierarchy_app_user"
      )
