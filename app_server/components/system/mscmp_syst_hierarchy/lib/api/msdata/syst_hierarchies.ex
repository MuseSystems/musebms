# Source File: syst_hierarchies.ex
# Location:    musebms/app_server/components/system/mscmp_syst_hierarchy/lib/api/msdata/syst_hierarchies.ex
...
defmodule Msdata.SystHierarchies do
  @moduledoc """
  ...
  schema "syst_hierarchies" do
    ...
    has_many(:hierarchy_items, Msdata.SystHierarchyItems, foreign_key: :hierarchy_id)
  end
end
