...
defmodule MscmpSystError do
  ...
  defmacro __using__(opts) do
    ...
    quote do
      ...
      The following attributes are those which are set or modified by the
      ...
      These attributes have their values set at compile time and are used
