...
# Location:    musebms/components/system/mscmp_syst_db/lib/db_types/impl/date_time.ex
...
defimpl MscmpSystDb.DbTypes.Range, for: DateTime do
  ...
  def bounds_compare(left, right), do: Impl.DateTime.bounds_compare(left, right)
