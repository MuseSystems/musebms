# Source File: inet.ex
# Location:    musebms/app_server/components/system/mscmp_syst_db/lib/api/db_types/inet.ex
...
defmodule MscmpSystDb.DbTypes.Inet do
  ...
  alias MscmpSystDb.Impl.DbTypes.Inet
  ...
  defdelegate to_postgrex_inet(address), to: Inet
  ...
  defdelegate from_postgrex_inet(address), to: Inet
  ...
  defdelegate to_net_address(address_or_network), to: Inet
  ...
  defdelegate from_net_address(address_or_network), to: Inet
end
