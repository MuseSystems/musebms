...
# Location:    musebms/app_server/components/system/mscmp_syst_db/lib/impl/db_types/integer_range.ex
...
defimpl MscmpSystDb.DbTypes, for: MscmpSystDb.DbTypes.IntegerRange do
  alias MscmpSystDb.Impl.DbTypes.IntegerRange
...
defimpl MscmpSystDb.DbTypes.Range, for: MscmpSystDb.DbTypes.IntegerRange do
  alias MscmpSystDb.Impl.DbTypes.IntegerRange

  def bounds_compare(left, right), do: IntegerRange.bounds_compare(left, right)
  def lower(range), do: IntegerRange.lower(range)
  def upper(range), do: IntegerRange.upper(range)
end

defmodule MscmpSystDb.Impl.DbTypes.IntegerRange do
  @moduledoc false
  ...
  def bounds_compare(%DbTypes.IntegerRange{} = left, right) when is_integer(right) do
    right_range = %DbTypes.IntegerRange{
      lower: right,
      upper: right,
  ...
  def bounds_compare(%DbTypes.IntegerRange{} = left, %DbTypes.IntegerRange{} = right) do
    left_lower = calc_lower(left.lower, left.lower_inclusive)
    left_upper = calc_upper(left.upper, left.upper_inclusive)
