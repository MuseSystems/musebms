...
# Location:    musebms/app_server/components/system/mscmp_syst_db/lib/impl/db_types/integer.ex
...
defimpl MscmpSystDb.DbTypes, for: Integer do
  alias MscmpSystDb.Impl.DbTypes.Integer

  def compare(left, right), do: Integer.compare(left, right)

  def test_compare(left, right, operator), do: Integer.test_compare(left, right, operator)
end

defimpl MscmpSystDb.DbTypes.Range, for: Integer do
  alias MscmpSystDb.Impl.DbTypes.Integer

  def bounds_compare(left, right), do: Integer.bounds_compare(left, right)
  def upper(value), do: value
  def lower(value), do: value
end

defmodule MscmpSystDb.Impl.DbTypes.Integer do
  @moduledoc false
