...
# Location:    musebms/app_server/components/system/mscmp_syst_db/lib/impl/db_types/decimal_range.ex
...
defimpl MscmpSystDb.DbTypes, for: MscmpSystDb.DbTypes.DecimalRange do
...
defimpl MscmpSystDb.DbTypes.Range, for: MscmpSystDb.DbTypes.DecimalRange do
  alias MscmpSystDb.Impl.DbTypes.DecimalRange
...
defmodule MscmpSystDb.Impl.DbTypes.DecimalRange do
  @moduledoc false
