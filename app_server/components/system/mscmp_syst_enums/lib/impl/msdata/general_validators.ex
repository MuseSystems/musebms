...
defmodule MscmpSystEnums.Impl.Msdata.GeneralValidators do
  ...
  @limit_opts NimbleOptions.new!(limit_opts)

  @spec get_limit_opts_docs(keyword()) :: String.t()
  def get_limit_opts_docs(opts), do: NimbleOptions.docs(@limit_opts, opts)

  @spec resolve_options(keyword()) :: keyword()
  def resolve_options(opts), do: NimbleOptions.validate!(opts, @limit_opts)
