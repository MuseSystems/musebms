...
# Location:    musebms/app_server/components/system/mscmp_syst_enums/dev_support/dev_support.ex
  ...
  def start_dev_environment(db_kind \\ :unit_testing) do
    children =
      [
        ...
        MscmpSystEnums.child_spec(
          service_name: @enums_service_name,
    ...
    {:ok, _pid} =
      Supervisor.start_link(
        ...
        name: :"MscmpSystEnums.DevSupportSupervisor"
      )
