...
defmodule EnumsTest do
  ...
  test "Get Enum Values" do
    assert %Msdata.SystEnums{
           ...
           } = MscmpSystEnums.get_values("test_syst_enum_one")
  ...
  test "Get All Enum Values" do
    assert all_enums = MscmpSystEnums.list_all()
  ...
  test "Is Enumeration User Maintainable" do
    assert false ===
             MscmpSystEnums.get_user_maintainable("test_syst_enum_one")

    assert true ===
             MscmpSystEnums.get_user_maintainable("test_syst_enum_three")
  end
  ...
  test "Create New Enumeration With Functional Types" do
    new_enum = %{
      ...
      enum_items: [
        %{
          internal_name: "create_test_item_three",
          ...
          functional_type_name: "create_func_type_one"
        },
        %{
          internal_name: "create_test_item_one",
        ...
        %{
          internal_name: "create_test_item_two",
          display_name: "Create Enum Test / Item Two",
          external_name: "Item Two",
          user_description: "A testing enumeration item",
          enum_default: false,
          functional_type_default: true,
          functional_type_name: "create_func_type_two",
          sort_order: 2
        }
      ]
    }

    assert :ok = MscmpSystEnums.create(new_enum)

    assert %{internal_name: "create_test"} =
             MscmpSystEnums.get_values("create_test")

    saved_enum_items = MscmpSystEnums.list_sorted_items("create_test")

    assert 3 = length(saved_enum_items)

    assert %{internal_name: "create_test_item_one", sort_order: 1} = hd(saved_enum_items)
  end

  test "Create New Enumeration With No Items" do
    new_enum = %{
      internal_name: "create_no_items_test",
      display_name: "Create Enum No Items Test",
      user_description: "A test of enumeration creation.",
      functional_types: [
        %{
          internal_name: "create_no_items_func_type_one",
          display_name: "Create Enum No Items Test / Func Type One",
          external_name: "Func Type One",
          user_description: "A testing functional type - One"
        },
        %{
          internal_name: "create_no_items_func_type_two",
    ...
    assert %{internal_name: "create_no_items_test", functional_types: functional_types} =
             MscmpSystEnums.get_values("create_no_items_test")

    assert 2 == length(functional_types)

    saved_enum_items = MscmpSystEnums.list_sorted_items("create_no_items_test")
  ...
  test "Create New Enumeration Without Functional Types" do
    new_enum = %{
      ...
      enum_items: [
        ...
        %{
          internal_name: "create_test_no_func_type_item_one",
        ...
        %{
          internal_name: "create_test_no_func_type_item_two",
    ...
    assert %{internal_name: "create_test_no_func_type"} =
             MscmpSystEnums.get_values("create_test_no_func_type")

    saved_enum_items = MscmpSystEnums.list_sorted_items("create_test_no_func_type")

    assert 3 = length(saved_enum_items)

    assert %{internal_name: "create_test_no_func_type_item_one", sort_order: 1} =
             hd(saved_enum_items)
  end

  test "Create New Enumeration Without Functional Types or Items" do
    new_enum = %{
      internal_name: "create_test_no_func_type_no_items",
    ...
    assert %{internal_name: "create_test_no_func_type_no_items"} =
             MscmpSystEnums.get_values("create_test_no_func_type_no_items")

    saved_enum_items =
      MscmpSystEnums.list_sorted_items("create_test_no_func_type_no_items")
  ...
  test "User Defined Enum Changes" do
    ...
    catch_error(MscmpSystEnums.get_values("user_define_enum_changes_test_old"))

    assert %{internal_name: "user_define_enum_changes_test_new"} =
             MscmpSystEnums.get_values("user_define_enum_changes_test_new")
  ...
  test "Delete User Defined Enumeration" do
    ...
    assert(%Msdata.SystEnums{} = MscmpSystEnums.get_values("delete_user_defined_enum"))

    assert :ok = MscmpSystEnums.delete("delete_user_defined_enum")

    catch_error(MscmpSystEnums.get_values("delete_user_defined_enum"))
  end

  test "Delete System Defined Enumeration" do
    assert {:error, _} = MscmpSystEnums.delete("test_syst_enum_three")

    assert(%Msdata.SystEnums{} = MscmpSystEnums.get_values("test_syst_enum_three"))
  end
  ...
  test "Delete User Defined Enum Items / User Defined Enum" do
    ...
    before_enum_items = MscmpSystEnums.list_items("delete_user_def_enum_item_enum")
    ...
    after_enum_items = MscmpSystEnums.list_items("delete_user_def_enum_item_enum")
  ...
  test "Can Lookup Enum Item by Name" do
    assert %Msdata.SystEnumItems{internal_name: "enum_two_closed"} =
             MscmpSystEnums.get_item_by_name("test_syst_enum_two", "enum_two_closed")
  end

  test "Can Lookup Enum Item by Id" do
    [test_enum_item | _] = MscmpSystEnums.list_items("test_syst_enum_one")

    assert ^test_enum_item =
             MscmpSystEnums.get_item_by_id("test_syst_enum_one", test_enum_item.id)
  end
end
