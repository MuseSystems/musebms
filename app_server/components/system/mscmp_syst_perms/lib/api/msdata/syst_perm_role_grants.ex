...
# Location:    musebms/app_server/components/system/mscmp_syst_perms/lib/api/msdata/syst_perm_role_grants.ex
...
defmodule Msdata.SystPermRoleGrants do
  ...
  alias MscmpSystPerms.Impl.Msdata.SystPermRoleGrants.Validators
