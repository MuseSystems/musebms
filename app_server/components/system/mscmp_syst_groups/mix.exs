# Source File: mix.exs
# Location:    musebms/app_server/components/system/mscmp_syst_groups/mix.exs
...
defmodule MscmpSystGroups.MixProject do
  use Mix.Project

  @name :mscmp_syst_groups
  @version "0.1.0"
  ...
  def project do
    ...
    [
      ...
      docs: [
        name: "MscmpSystGroups",
        main: "MscmpSystGroups",
        output: "../../../../documentation/technical/app_server/mscmp_syst_groups",
