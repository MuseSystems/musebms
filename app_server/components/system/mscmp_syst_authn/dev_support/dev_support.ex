...
# Location:    musebms/app_server/components/system/mscmp_syst_authn/dev_support/dev_support.ex
...
defmodule DevSupport do
  ...
  @migration_doc_test_ds_type "mscmp_syst_authn_doc_test"

  @registry :"MscmpSystAuthn.DevSupportRegistry"
  ...
  def stop_dev_environment do
    _ = cleanup_database()
    Supervisor.stop(:"MscmpSystAuthn.DevSupportSupervisor")
  end
