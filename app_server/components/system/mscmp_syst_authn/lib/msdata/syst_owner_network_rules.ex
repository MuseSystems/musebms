...
# Location:    musebms/components/system/mscmp_syst_authn/lib/msdata/syst_owner_network_rules.ex
...
defmodule Msdata.SystOwnerNetworkRules do
  ...
  defdelegate insert_changeset(insert_params), to: Validators.SystOwnerNetworkRules
  ...
  defdelegate update_changeset(owner_network_rule, update_params),
    to: Validators.SystOwnerNetworkRules
end
