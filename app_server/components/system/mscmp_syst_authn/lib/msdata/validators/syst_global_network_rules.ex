...
# Location:    musebms/components/system/mscmp_syst_authn/lib/msdata/validators/syst_global_network_rules.ex
...
defmodule MscmpSystAuthn.Msdata.Validators.SystGlobalNetworkRules do
  ...
  def insert_changeset(insert_params) do
    resolved_params = Helpers.General.resolve_network_rule_params_func_type(insert_params)
