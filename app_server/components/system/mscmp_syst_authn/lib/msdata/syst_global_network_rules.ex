...
# Location:    musebms/components/system/mscmp_syst_authn/lib/msdata/syst_global_network_rules.ex
...
defmodule Msdata.SystGlobalNetworkRules do
  ...
  defdelegate insert_changeset(insert_params), to: Validators.SystGlobalNetworkRules
  ...
  defdelegate update_changeset(global_network_rule, update_params),
    to: Validators.SystGlobalNetworkRules
end
