...
# Location:    musebms/app_server/components/system/mscmp_syst_authn/lib/api/msdata/syst_disallowed_hosts.ex
...
defmodule Msdata.SystDisallowedHosts do
  ...
  alias MscmpSystAuthn.Impl.Msdata.SystDisallowedHosts.Validators
  ...
  defdelegate insert_changeset(host_address), to: Validators
end
