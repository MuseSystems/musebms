...
# Location:    musebms/app_server/components/system/mscmp_syst_authn/lib/api/msdata/syst_credentials.ex
...
defmodule Msdata.SystCredentials do
  ...
  alias MscmpSystAuthn.Impl.Msdata.SystCredentials.Validators
  ...
  @spec update_changeset(Msdata.SystCredentials.t(), Types.credential_params()) ::
          Ecto.Changeset.t()
  defdelegate update_changeset(credential, update_params), to: Validators
end
