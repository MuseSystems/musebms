...
# Location:    musebms/app_server/components/system/mscmp_syst_authn/lib/api/msdata/syst_password_history.ex
...
defmodule Msdata.SystPasswordHistory do
  ...
  alias MscmpSystAuthn.Impl.Msdata.SystPasswordHistory.Validators
  ...
  defdelegate insert_changeset(access_account_id, credential_data), to: Validators
end
