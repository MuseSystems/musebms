...
# Location:    musebms/app_server/components/system/mscmp_syst_authn/lib/api/msdata/syst_disallowed_passwords.ex
...
defmodule Msdata.SystDisallowedPasswords do
  ...
  alias MscmpSystAuthn.Impl.Msdata.SystDisallowedPasswords.Validators
  ...
  defdelegate insert_changeset(password_hash), to: Validators
end
