...
# Location:    musebms/app_server/components/system/mscmp_syst_authn/lib/api/msdata/syst_owner_network_rules.ex
...
defmodule Msdata.SystOwnerNetworkRules do
  ...
  alias MscmpSystAuthn.Impl.Msdata.SystOwnerNetworkRules.Validators
  ...
  defdelegate update_changeset(owner_network_rule, update_params), to: Validators
end
