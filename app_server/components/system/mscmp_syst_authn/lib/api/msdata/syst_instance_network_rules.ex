...
# Location:    musebms/app_server/components/system/mscmp_syst_authn/lib/api/msdata/syst_instance_network_rules.ex
...
defmodule Msdata.SystInstanceNetworkRules do
  ...
  alias MscmpSystAuthn.Impl.Msdata.SystInstanceNetworkRules.Validators
  ...
  defdelegate update_changeset(instance_id, update_params), to: Validators
end
