...
# Location:    musebms/app_server/components/system/mscmp_syst_authn/lib/impl/msdata/syst_instance_network_rules/validators.ex
...
defmodule MscmpSystAuthn.Impl.Msdata.SystInstanceNetworkRules.Validators do
  @moduledoc false
  ...
  def resolve_name_params(network_rule_params, _operation),
    do: Helpers.resolve_instance_id(network_rule_params)
end
