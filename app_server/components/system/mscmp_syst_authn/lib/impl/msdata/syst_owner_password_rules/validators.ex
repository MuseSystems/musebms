...
# Location:    musebms/app_server/components/system/mscmp_syst_authn/lib/impl/msdata/syst_owner_password_rules/validators.ex
...
defmodule MscmpSystAuthn.Impl.Msdata.SystOwnerPasswordRules.Validators do
  @moduledoc false
  ...
  defp resolve_name_params(password_rule_params, _operation),
    do: Helpers.resolve_owner_id(password_rule_params)
end
