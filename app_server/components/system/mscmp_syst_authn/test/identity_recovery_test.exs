...
# Location:    musebms/app_server/components/system/mscmp_syst_authn/test/identity_recovery_test.exs
...
defmodule IdentityRecoveryTest do
  ...
  describe "recovery request functionality" do
  ...
  describe "access account recovery status" do
    test "Can test if Access Account is recoverable" do
      ...
      {:ok, no_pwd_access_account_id} =
        Impl.AccessAccount.get_access_account_id_by_name(
          "identity_recovery_no_password_test_accnt"
        )
  ...
  describe "identity verification" do
    test "Can identify Owned Access Account" do
      ...
      assert {:ok, %Msdata.SystIdentities{id: ^recovery_identity_id}} =
  ...
  describe "recovery management" do
