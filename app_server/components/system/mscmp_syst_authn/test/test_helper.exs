...
# Location:    musebms/app_server/components/system/mscmp_syst_authn/test/test_helper.exs
...
test_registry = MscmpSystAuthn.TestRegistry
...
{:ok, _pid} =
  Supervisor.start_link(children,
    ...
    name: :"MscmpSystAuthn.TestSupportSupervisor"
  )

instance_service_spec = %{
  id: TestingInstanceServices,
  start: {MscmpSystAuthn, :start_link, []}
}

DynamicSupervisor.start_child(MscmpSystAuthn.TestingSupervisor, instance_service_spec)
