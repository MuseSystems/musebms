...
# Location:    musebms/app_server/components/system/mscmp_syst_instance/test/instance_type_test.exs
...
defmodule InstanceTypeTest do
  ...
  test "Can Delete Instance Type" do
    ...
    assert is_nil(MscmpSystEnums.get_item_by_name("instance_types", create_params.internal_name))
  end
end
