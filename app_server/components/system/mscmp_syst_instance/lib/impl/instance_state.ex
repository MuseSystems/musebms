...
# Location:    musebms/app_server/components/system/mscmp_syst_instance/lib/impl/instance_state.ex
...
defmodule MscmpSystInstance.Impl.InstanceState do
  ...
  def get_instance_state_by_name(instance_state_name),
    do: MscmpSystEnums.get_item_by_name("instance_states", instance_state_name)
  ...
  def get_instance_state_default(nil), do: MscmpSystEnums.get_default_item("instance_states")
  ...
  def get_instance_state_default(functional_type) when is_atom(functional_type) do
    MscmpSystEnums.get_default_item("instance_states",
