...
# Location:    musebms/components/system/mscmp_syst_instance/lib/msdata/syst_instance_type_applications.ex
...
defmodule Msdata.SystInstanceTypeApplications do
  ...
  defdelegate insert_changeset(insert_params), to: Validators.SystInstanceTypeApplications
end
