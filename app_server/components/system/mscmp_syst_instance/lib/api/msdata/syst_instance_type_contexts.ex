...
# Location:    musebms/app_server/components/system/mscmp_syst_instance/lib/api/msdata/syst_instance_type_contexts.ex
...
defmodule Msdata.SystInstanceTypeContexts do
  ...
  alias MscmpSystInstance.Impl.Msdata.SystInstanceTypeContexts.Validators
  ...
  @spec update_changeset(
          ...
          Ecto.Changeset.t()
  defdelegate update_changeset(instance_type_context, update_params \\ %{}), to: Validators
end
