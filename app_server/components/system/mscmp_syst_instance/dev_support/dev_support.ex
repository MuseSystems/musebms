...
# Location:    musebms/app_server/components/system/mscmp_syst_instance/dev_support/dev_support.ex
...
defmodule DevSupport do
  ...
  @registry :"MscmpSystInstance.DevSupportRegistry"
  ...
  def stop_dev_environment do
    _ = cleanup_database()
    Supervisor.stop(:"MscmpSystInstance.DevSupportSupervisor")
  end
