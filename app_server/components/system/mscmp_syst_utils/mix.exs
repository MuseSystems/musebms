# Source File: mix.exs
# Location:    musebms/app_server/components/system/mscmp_syst_utils/mix.exs
  ...
  def project do
    ...
    [
      ...
      docs: [
        ...
        groups_for_docs: [],
        groups_for_modules: [
          "General Information": [Msutils],
          "String Utilities": [Msutils.String],
          "Process Utilities": [Msutils.Process],
          "Common Guards": [Msutils.Guards]
        ]
      ]
    ]
  end
