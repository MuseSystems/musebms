...
# Location:    musebms/app_server/components/system/mscmp_syst_mcp_perms/lib/api/msdata/syst_access_account_perm_role_assigns.ex
...
defmodule Msdata.SystAccessAccountPermRoleAssigns do
  ...
  alias MscmpSystMcpPerms.Impl.Msdata.SystAccessAccountPermRoleAssigns.Validators
