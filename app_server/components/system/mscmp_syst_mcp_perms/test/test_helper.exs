...
# Location:    musebms/app_server/components/system/mscmp_syst_mcp_perms/test/test_helper.exs
...
test_registry = MscmpSystMcpPerms.TestRegistry
...
{:ok, _pid} =
  Supervisor.start_link(children,
    ...
    name: :"MscmpSystMcpPerms.TestSupportSupervisor"
  )
