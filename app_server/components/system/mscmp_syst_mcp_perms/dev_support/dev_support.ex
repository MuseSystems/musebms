...
# Location:    musebms/app_server/components/system/mscmp_syst_mcp_perms/dev_support/dev_support.ex
...
defmodule DevSupport do
  ...
  @migration_doc_test_ds_type "mscmp_syst_mcp_perms_doc_test"

  @registry :"MscmpSystMcpPerms.DevSupportRegistry"
     ...
     children =
      ...
      {:ok, _pid} =
        Supervisor.start_link(
          children, strategy: :one_for_one, name: :"MscmpSystMcpPerms.DevSupportSupervisor")
  ...
  def stop_dev_environment do
    _ = cleanup_database()
    Supervisor.stop(:"MscmpSystMcpPerms.DevSupportSupervisor")
  end
