...
# Location:    musebms/app_server/components/system/mscmp_syst_nav/test/test_helper.exs
...
test_registry = MscmpSystNav.TestRegistry
...
{:ok, _pid} =
  Supervisor.start_link(children,
    ...
    name: :"MscmpSystNav.TestSupportSupervisor"
  )
