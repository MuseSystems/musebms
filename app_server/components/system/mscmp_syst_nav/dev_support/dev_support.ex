...
# Location:    musebms/app_server/components/system/mscmp_syst_nav/dev_support/dev_support.ex
...
defmodule DevSupport do
  ...
  @registry :"MscmpSystNav.DevSupportRegistry"
     ...
     children =
      ...
      {:ok, _pid} =
        Supervisor.start_link(
          children, strategy: :one_for_one, name: :"MscmpSystNav.DevSupportSupervisor")
  ...
  def stop_dev_environment do
    _ = cleanup_database()
    Supervisor.stop(:"MscmpSystNav.DevSupportSupervisor")
  end
