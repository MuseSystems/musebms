...
# Location:    musebms/app_server/components/system/mscmp_syst_interaction/dev_support/dev_support.ex
...
defmodule DevSupport do
  ...
  use MscmpSystInteraction.Macros

  db_devsupport(:dev)
  interaction_devsupport(:dev)

  @migration_test_source_root_dir "../../../../database"
  @migration_unit_test_ds_type "mscmp_syst_interaction_unit_test"
  @migration_integration_test_ds_type "mscmp_syst_interaction_integration_test"
  @migration_doc_test_ds_type "mscmp_syst_interaction_doc_test"

  @registry :"MscmpSystInteraction.DevSupportRegistry"
    ...
    children =
      [
        ...
        MscmpSystInteraction.child_spec(
          service_name: @interaction_service_name, datastore_context_name: @datastore_context_name )
      ]

      {:ok, _pid} =
        Supervisor.start_link(
          children, strategy: :one_for_one, name: :"MscmpSystInteraction.DevSupportSupervisor")

    _ = MscmpSystDb.put_datastore_context(@datastore_context_name)
    _ = MscmpSystInteraction.put_service(@interaction_service_name)
  ...
  def stop_dev_environment do
    _ = cleanup_database()
    Supervisor.stop(:"MscmpSystInteraction.DevSupportSupervisor")
  end
