...
# Location:    musebms/app_server/components/system/mscmp_syst_interaction/test/support/test_support.ex
...
defmodule TestSupport do
  ...
  def setup_testing_database(test_kind, opts) do
    ...
    MscmpSystDb.Datastore.child_spec(datastore_options,
      context_registry: opts[:context_registry] || MscmpSystInteraction.TestRegistry
    )
  end
  ...
  @spec get_service_name() :: atom()
  def get_service_name, do: @interaction_service_name
