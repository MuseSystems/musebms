# Source File: syst_interaction_actions.ex
# Location:    musebms/app_server/components/system/mscmp_syst_interaction/lib/api/msdata/syst_interaction_actions.ex
...
defmodule Msdata.SystInteractionActions do
  ...
  schema "syst_interaction_actions" do
