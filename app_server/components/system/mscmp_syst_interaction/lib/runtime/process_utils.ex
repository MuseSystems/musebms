...
defmodule MscmpSystInteraction.Runtime.ProcessUtils do
  ...
  def get_runtime_config, do: Process.get(:"MscmpSystInteraction.runtime_config")
  ...
  def put_service(nil) do
    ...
    _ = Process.put(:"MscmpSystInteraction.runtime_config", nil)
  ...
  def put_service(service_name) do
    ...
    runtime_config = GenServer.call(service_name, :get_runtime_config)
    Process.put(:"MscmpSystInteraction.table_name", context_table)
    Process.put(:"MscmpSystInteraction.runtime_config", runtime_config)
