...
# Location:    musebms/app_server/components/system/mscmp_syst_settings/test/process_utils_test.exs
...
defmodule ProcessUtilsTest do
  ...
  defp reset_process_dict do
    ...
    Process.put(:"MscmpSystSettings.runtime_config", nil)
  end

  defp get_curr_service_name, do: Process.get(:"MscmpSystSettings.service_name")
  defp get_curr_runtime_config, do: Process.get(:"MscmpSystSettings.runtime_config")
  ...
  describe "put_service/1 tests" do
    ...
    test "Repeated calls don't change state" do
      ...
      assert TestSupport.get_settings_service_name() ===
               Process.get(:"MscmpSystSettings.service_name")
  ...
  describe "get_runtime_config/0 tests" do
    ...
    test "getting runtime config after service unset" do
      ...
      assert %{datastore_context_name: _, settings_table: _} = ProcessUtils.get_runtime_config()
