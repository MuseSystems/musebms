...
# Location:    musebms/app_server/components/application/mscmp_core_hierarchy/lib/impl/hierarchy.ex
...
defmodule MscmpCoreHierarchy.Impl.Hierarchy do
  @moduledoc false
  ...
  def get_hierarchy_id_by_name!(hierarchy_name) do
    from(h in Msdata.ConfHierarchies,
      select: h.id,
