# Source File: mix.exs
# Location:    musebms/app_server/components/application/mscmp_core_hierarchy/mix.exs
...
defmodule MscmpCoreHierarchy.MixProject do
  use Mix.Project

  @name :mscmp_core_hierarchy
  @version "0.1.0"
  ...
  @deps [
    ...
    {:mscmp_syst_enums, path: "../../system/mscmp_syst_enums"}
  ]
