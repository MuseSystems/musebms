...
# Location:    musebms/app_server/components/application/mscmp_core_groups/test/test_helper.exs
...
children = [
  {DynamicSupervisor, strategy: :one_for_one, name: MscmpCoreGroups.TestingSupervisor}
]
