...
# Location:    musebms/app_server/components/application/mscmp_core_groups/test/support/test_support.ex
...
defmodule TestSupport do
  ...
  @datastore_options %DatastoreOptions{
    database_name: "mscmp_core_groups",
    datastore_code: "mscmp_core_groups.testing.code",
    datastore_name: :mscmp_core_groups,
    contexts: [
      %DatastoreContext{
        context_name: nil,
        description: "MscmpCoreGroups Testing Owner",
        database_role: "mscmp_core_groups_owner",
      ...
      %DatastoreContext{
        ...
        description: "MscmpCoreGroups Testing App User",
        database_role: "mscmp_core_groups_app_user",
        database_password: "mscmp_core_groups.testing.code.app.user",
    ...
    db_server: %DbServer{
      ...
      db_max_instances: 1,
      server_salt: "mscmp_core_groups.testing.code.test.salt",
  ...
  @migration_test_datastore_type "mscmp_core_groups_unit_test"
  ...
  def setup_testing_database do
    ...
    {:ok, _} =
      MscmpSystDb.upgrade_datastore(
        ...
        ms_appusr: "mscmp_core_groups_app_user"
      )
