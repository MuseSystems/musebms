...
# Location:    musebms/app_server/components/application/mscmp_core_groups/dev_support/dev_support.ex
...
defmodule DevSupport do
  ...
  @migration_unit_test_ds_type "mscmp_core_groups_unit_test"
