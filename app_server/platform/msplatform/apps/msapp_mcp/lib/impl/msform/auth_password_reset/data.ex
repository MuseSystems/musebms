# Source File: data.ex
# Location:    musebms/app_server/platform/msplatform/apps/msapp_mcp/lib/impl/msform/auth_password_reset/data.ex
...
defmodule MsappMcp.Impl.Msform.AuthPasswordReset.Data do
  @moduledoc false

  import Ecto.Changeset

  @spec validate_save(Msform.AuthPasswordReset.t(), Msform.AuthPasswordReset.parameters()) ::
          Ecto.Changeset.t()
  def validate_save(original_data, current_data),
    do: validate_post(original_data, current_data)

  @spec validate_post(Msform.AuthPasswordReset.t(), Msform.AuthPasswordReset.parameters()) ::
          Ecto.Changeset.t()
