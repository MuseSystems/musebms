...
# Location:    musebms/app_server/platform/msplatform/apps/msapp_mcp/lib/impl/msform/mcp_bootstrap/actions.ex
...
defmodule MsappMcp.Impl.Msform.McpBootstrap.Actions do
  @moduledoc false
