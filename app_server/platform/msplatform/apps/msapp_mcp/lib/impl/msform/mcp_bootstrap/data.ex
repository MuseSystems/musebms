# Source File: data.ex
# Location:    musebms/app_server/platform/msplatform/apps/msapp_mcp/lib/impl/msform/mcp_bootstrap/data.ex
...
defmodule MsappMcp.Impl.Msform.McpBootstrap.Data do
  @moduledoc false

  import Ecto.Changeset

  @spec validate_save(Msform.McpBootstrap.t(), Msform.McpBootstrap.parameters()) ::
          Ecto.Changeset.t()
  def validate_save(original_data, current_data), do: validate_post(original_data, current_data)

  @spec validate_post(Msform.McpBootstrap.t(), Msform.McpBootstrap.parameters()) ::
          Ecto.Changeset.t()
