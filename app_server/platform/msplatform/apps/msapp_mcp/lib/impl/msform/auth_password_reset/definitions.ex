...
# Location:    musebms/app_server/platform/msplatform/apps/msapp_mcp/lib/impl/msform/auth_password_reset/definitions.ex
...
defmodule MsappMcp.Impl.Msform.AuthPasswordReset.Definitions do
  @moduledoc false
