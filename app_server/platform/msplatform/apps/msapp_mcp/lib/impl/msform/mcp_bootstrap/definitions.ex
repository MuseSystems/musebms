...
# Location:    musebms/app_server/platform/msplatform/apps/msapp_mcp/lib/impl/msform/mcp_bootstrap/definitions.ex
...
defmodule MsappMcp.Impl.Msform.McpBootstrap.Definitions do
  @moduledoc false
