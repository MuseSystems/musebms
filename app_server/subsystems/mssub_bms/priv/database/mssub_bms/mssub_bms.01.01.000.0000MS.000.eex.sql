...
-- Location:    musebms/database/application/msbms/gen_seed_data/feature_mapping.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
...
updates can be found.  This row starts at 0 and therefore may be the same as the
diag_row_version - 1.$DOC$;
-- File:        enum_place_types.eex.sql
-- Location:    musebms/database/components/application/mscmp_brm_place/seed_data/enum_place_types.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
...
updates can be found.  This row starts at 0 and therefore may be the same as the
diag_row_version - 1.$DOC$;
-- File:        enum_contact_types.eex.sql
-- Location:    musebms/database/components/application/mscmp_brm_contact/seed_data/enum_contact_types.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
...
updates can be found.  This row starts at 0 and therefore may be the same as the
diag_row_version - 1.$DOC$;
-- File:        enum_interaction_types.eex.sql
-- Location:    musebms/database/components/application/mscmp_syst_interactions/seed_data/enum_interaction_types.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
...
END;
$INIT_ENUM$;
-- File:        enum_login_states.eex.sql
-- Location:    musebms/database/components/application/mscmp_syst_interactions/seed_data/enum_login_states.eex.sql
-- Project:     Muse Systems Business Management System
--
-- Copyright © Lima Buttgereit Holdings LLC d/b/a Muse Systems
-- This file may include content copyrighted and licensed from third parties.
