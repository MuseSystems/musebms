...
defmodule MssubMcp do
  ...
  @default_session_expire_secs 3600
  ...
  * `instance_network_rule_id` - the record ID of the desired Instance Network
  ...
  defdelegate create_session(session_data, expires_after_secs \\ @default_session_expire_secs),
    to: Runtime.DbSessionManager
  ...
  minutes from retrieval time.
      ...
      iex> {:ok, %{}} = MssubMcp.get_session("example_session", 1800)
  ...
  defdelegate get_session(session_name, expires_after_secs \\ @default_session_expire_secs),
    to: Runtime.DbSessionManager
  ...
  Refreshing a Session expiration date/time to 30 minutes from refresh time.
      ...
      iex> MssubMcp.refresh_session_expiration("example_session", 1800)
      :ok
  ...
  defdelegate refresh_session_expiration(
                session_name,
                expires_after_secs \\ @default_session_expire_secs
              ),
              to: Runtime.DbSessionManager
  ...
  30 minutes from update time.
      ...
      iex> MssubMcp.update_session("example_update_session", %{updated_key: "updated_value"}, 1800)
      :ok
  ...
  defdelegate purge_expired_sessions, to: Runtime.DbSessionManager
