...
-- Location:    musebms/database/application/msbms_instance/mod_brm/msbms_appl_data/mstr_places/mstr_places.eex.sql
...
CREATE CONSTRAINT TRIGGER a50_trig_a_i_place_states_enum_item_check
    ...
    FOR EACH ROW EXECUTE PROCEDURE
        msbms_syst_priv.trig_a_iu_enum_item_check('place_states', 'place_state_id');
...
CREATE CONSTRAINT TRIGGER a50_trig_a_i_place_types_enum_item_check
    AFTER INSERT ON msbms_appl_data.mstr_places
    FOR EACH ROW EXECUTE PROCEDURE
        msbms_syst_priv.trig_a_iu_enum_item_check('place_types', 'place_type_id');
