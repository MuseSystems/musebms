...
-- Location:    musebms/database/application/msbms_instance/mod_brm/msbms_appl_data/mstr_country_address_format_assocs/mstr_country_address_format_assocs.eex.sql
...
CREATE TABLE msbms_appl_data.mstr_country_address_format_assocs
(
     id
        uuid
    ...
    ,country_id
        ...
        CONSTRAINT mstr_country_address_format_assocs_countries_fk
            REFERENCES msbms_appl_data.mstr_countries (id) ON DELETE CASCADE
    ,address_format_id
        uuid
        NOT NULL
...
ALTER TABLE msbms_appl_data.mstr_country_address_format_assocs OWNER TO <%= msbms_owner %>;

REVOKE ALL ON TABLE msbms_appl_data.mstr_country_address_format_assocs FROM public;
GRANT ALL ON TABLE msbms_appl_data.mstr_country_address_format_assocs TO <%= msbms_owner %>;
...
COMMENT ON
    COLUMN msbms_appl_data.mstr_country_address_format_assocs.diag_role_created IS
$DOC$The database role which created the record.$DOC$;

COMMENT ON
    COLUMN msbms_appl_data.mstr_country_address_format_assocs.diag_timestamp_modified IS
$DOC$The database server date/time when the transaction which modified the record
started.  This field will be the same as diag_timestamp_created for inserted
records.$DOC$;

COMMENT ON
    COLUMN msbms_appl_data.mstr_country_address_format_assocs.diag_wallclock_modified IS
$DOC$The database server date/time at the moment the record was actually modified.
For long running transactions this time may be significantly later than the
value of diag_timestamp_modified.$DOC$;

COMMENT ON
    COLUMN msbms_appl_data.mstr_country_address_format_assocs.diag_role_modified IS
$DOC$The database role which modified the record.$DOC$;

COMMENT ON
    COLUMN msbms_appl_data.mstr_country_address_format_assocs.diag_row_version IS
...
COMMENT ON
    COLUMN msbms_appl_data.mstr_country_address_format_assocs.diag_update_count IS
