...
-- Location:    musebms/database/cmp_msbms_syst_authentication/msbms_syst/api_views/syst_global_network_rules/trig_i_d_syst_global_network_rules.eex.sql
...
BEGIN
    ...
    DELETE FROM msbms_syst_data.syst_global_network_rules WHERE id = old.id RETURNING * INTO old;
