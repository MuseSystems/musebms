...
-- Location:    database\global\msbms_syst_data\tables\syst_access_account_instance_assocs.eex.sql
...
(
    ...
    ,instance_id             uuid                                    NOT NULL
        ...
        REFERENCES msbms_syst_data.syst_instances (id)
            ON DELETE CASCADE
    ,access_granted          timestamptz
    ,invitation_issued       timestamptz
    ,invitation_expires      timestamptz
    ,invitation_declined     timestamptz
