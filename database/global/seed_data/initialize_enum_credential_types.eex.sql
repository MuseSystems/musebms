...
-- Location:    database\global\seed_data\initialize_enum_credential_types.eex.sql
          ...
          "enum_values": [
            {
              ...
              "display_name": "Credential Type / Password",
              "external_name": "Password",
              "functional_type_internal_name": "credential_types_password",
              "enum_default": true,
            ...
            },
            {
              ...
              "display_name": "Credential Type / Secondary, TOTP",
              "external_name": "Secondary, TOTP",
              "functional_type_internal_name": "credential_types_secondary_totp",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
            ...
            },
            {
              ...
              "display_name": "Credential Type / API Token",
              "external_name": "API Token",
              "functional_type_internal_name": "credential_types_token_api",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
            ...
            },
            {
              ...
              "display_name": "Credential Type / Validation Token",
              "external_name": "Validation Token",
              "functional_type_internal_name": "credential_types_token_validation",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
            ...
            },
            {
              ...
              "display_name": "Credential Type / Recovery Token",
              "external_name": "Recovery Token",
              "functional_type_internal_name": "credential_types_token_recovery",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
