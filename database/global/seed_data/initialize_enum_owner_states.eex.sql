...
-- Location:    database\global\seed_data\initialize_enum_owner_states.eex.sql
        ...
        p_enum_def => $INIT_ENUM_OWNER_STATES$
        {
          ...
          "enum_values": [
            ...
            },
            {
              ...
              "display_name": "Owner State / Suspended",
              "external_name": "Suspended",
              "functional_type_internal_name": "owner_states_suspended",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
            ...
            },
            {
              ...
              "display_name": "Owner State / Inactive",
              "external_name": "Inactive",
              "functional_type_internal_name": "owner_states_inactive",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
            ...
            },
            {
              ...
              "display_name": "Owner State / Purge Eligible",
              "external_name": "Purge Eligible",
              "functional_type_internal_name": "owner_states_purge_eligible",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
