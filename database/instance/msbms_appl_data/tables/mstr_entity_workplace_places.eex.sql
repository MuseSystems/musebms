-- Source File: mstr_entity_workplace_places.eex.sql
-- Location:    msbms/database/instance/msbms_appl_data/tables/mstr_entity_workplace_places.eex.sql
-- Project:     musebms
--
...
(
    ...
    ,place_id                uuid                                    NOT NULL
        CONSTRAINT mstr_entity_workplace_places_place_id_fk
        REFERENCES msbms_appl_data.mstr_places (id)
        ON DELETE CASCADE
    ,owning_entity_id       uuid                                     NOT NULL
        CONSTRAINT mstr_entity_workplace_places_owning_entity_id_fk
