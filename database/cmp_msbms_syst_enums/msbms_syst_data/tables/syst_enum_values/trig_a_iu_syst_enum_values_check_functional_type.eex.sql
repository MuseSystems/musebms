CREATE OR REPLACE FUNCTION msbms_syst_data.trig_a_iu_syst_enum_values_check_functional_types()
RETURNS trigger AS
$BODY$

-- File:        trig_a_iu_syst_enum_values_check_functional_type.eex.sql
-- Location:    database\cmp_msbms_syst_enums\msbms_syst_data\tables\syst_enum_values\trig_a_iu_syst_enum_values_check_functional_type.eex.sql
...
ALTER FUNCTION msbms_syst_data.trig_a_iu_syst_enum_values_check_functional_types()
    OWNER TO <%= msbms_owner %>;

REVOKE EXECUTE ON FUNCTION msbms_syst_data.trig_a_iu_syst_enum_values_check_functional_types() FROM public;
GRANT EXECUTE ON FUNCTION msbms_syst_data.trig_a_iu_syst_enum_values_check_functional_types() TO <%= msbms_owner %>;

COMMENT ON FUNCTION msbms_syst_data.trig_a_iu_syst_enum_values_check_functional_types() IS
