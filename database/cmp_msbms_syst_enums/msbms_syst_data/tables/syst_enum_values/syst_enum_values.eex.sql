...
-- Location:    database\cmp_msbms_syst_enums\msbms_syst_data\tables\syst_enum_values.eex.sql
...
CREATE TRIGGER a50_trig_b_i_syst_enum_values_maintain_sort_order
    ...
    FOR EACH ROW
EXECUTE PROCEDURE msbms_syst_data.trig_b_i_syst_enum_values_maintain_sort_order( );
