CREATE OR REPLACE FUNCTION msbms_syst_priv.trig_a_iu_syst_enum_values_maintain_sort_order()
RETURNS trigger AS
$BODY$

-- File:        trig_a_iu_syst_enum_values_maintain_sort_order.eex.sql
-- Location:    database\cmp_msbms_syst_enums\msbms_syst_priv\trigger_functions\syst_enum_values\trig_a_iu_syst_enum_values_maintain_sort_order.eex.sql
...
ALTER FUNCTION msbms_syst_priv.trig_a_iu_syst_enum_values_maintain_sort_order()
    OWNER TO <%= msbms_owner %>;

REVOKE EXECUTE ON FUNCTION msbms_syst_priv.trig_a_iu_syst_enum_values_maintain_sort_order() FROM public;
GRANT EXECUTE ON FUNCTION msbms_syst_priv.trig_a_iu_syst_enum_values_maintain_sort_order() TO <%= msbms_owner %>;


COMMENT ON FUNCTION msbms_syst_priv.trig_a_iu_syst_enum_values_maintain_sort_order() IS
