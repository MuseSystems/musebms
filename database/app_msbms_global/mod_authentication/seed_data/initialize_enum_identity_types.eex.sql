...
-- Location:    database\app_msbms_global\mod_authentication\seed_data\initialize_enum_identity_types.eex.sql
          ...
          "enum_items": [
            {
              ...
              "display_name": "Identity Type / Email",
              "external_name": "Email",
              "functional_type_internal_name": "identity_types_email",
              "enum_default": true,
            ...
            },
            {
              ...
              "display_name": "Identity Type / Account",
              "external_name": "Account",
              "functional_type_internal_name": "identity_types_account",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
            ...
            },
            {
              ...
              "display_name": "Identity Type / API",
              "external_name": "API",
              "functional_type_internal_name": "identity_types_api",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
            ...
            },
            {
              ...
              "display_name": "Identity Type / Validation",
              "external_name": "Validation",
              "functional_type_internal_name": "identity_types_validation",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
