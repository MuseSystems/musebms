...
-- Location:    database\app_msbms_global\mod_instance_mgr\seed_data\initialize_enum_instance_states.eex.sql
          ...
          "enum_items": [
            {
              ...
              "display_name": "Instance State / Uninitialized",
              "external_name": "Uninitialized",
              "functional_type_internal_name": "instance_states_uninitialized",
              "enum_default": true,
            ...
            },
            {
              ...
              "display_name": "Instance State / Initializing",
              "external_name": "Initializing",
              "functional_type_internal_name": "instance_states_initializing",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
            ...
            },
            {
              ...
              "display_name": "Instance State / Active",
              "external_name": "Active",
              "functional_type_internal_name": "instance_states_active",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
            ...
            },
            {
              ...
              "display_name": "Instance State / Suspended",
              "external_name": "Suspended",
              "functional_type_internal_name": "instance_states_suspended",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
            ...
            },
            {
              ...
              "display_name": "Instance State / Inactive",
              "external_name": "Inactive",
              "functional_type_internal_name": "instance_states_inactive",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
            ...
            },
            {
              ...
              "display_name": "Instance State / Purge Eligible",
              "external_name": "Purge Eligible",
              "functional_type_internal_name": "instance_states_purge_eligible",
              "enum_default": false,
              "functional_type_default": true,
              "syst_defined": true,
              "user_maintainable": true,
