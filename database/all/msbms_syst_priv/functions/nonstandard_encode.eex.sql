CREATE OR REPLACE FUNCTION
    msbms_syst_priv.nonstandard_encode(p_base integer, p_tokens text, p_value bigint)
RETURNS text AS
$BODY$

-- File:        nonstandard_encode.eex.sql
-- Location:    musebms/database/all/msbms_syst_priv/functions/nonstandard_encode.eex.sql
...
ALTER FUNCTION msbms_syst_priv.nonstandard_encode(p_base integer, p_tokens text, p_value bigint)
    OWNER TO <%= msbms_owner %>;

REVOKE EXECUTE ON FUNCTION
    msbms_syst_priv.nonstandard_encode(p_base integer, p_tokens text, p_value bigint) FROM public;
...
COMMENT ON
    FUNCTION msbms_syst_priv.nonstandard_encode(p_base integer, p_tokens text, p_value bigint) IS
