CREATE OR REPLACE FUNCTION ms_appl_data.trig_b_iu_supp_groups_validate_parent_group_type_item()
RETURNS trigger AS
$BODY$

-- File:        trig_b_iu_supp_groups_validate_parent_group_type_item.eex.sql
-- Location:    musebms/database/components/application/mscmp_core_groups/ms_appl_data/supp_groups/trig_b_iu_supp_groups_validate_parent_group_type_item.eex.sql
    ...
    IF
        ...
        coalesce(
            (   SELECT
                ...
                FROM
                    ms_appl_data.supp_group_type_items current_gti
                        JOIN ms_appl_data.supp_group_type_items expected_gti
        ...
        RAISE EXCEPTION
            USING
                ...
                DETAIL = ms_syst_priv.get_exception_details(
                            ...
                            ,p_proc_name      => 'trig_b_iu_supp_groups_validate_parent_group_type_item'
    ...
    IF
        ...
        coalesce(
            (   SELECT
                ...
                FROM
                    ms_appl_data.supp_group_type_items current_gti,
                    ms_appl_data.supp_groups parent
                    JOIN ms_appl_data.supp_group_type_items parent_gti
...
ALTER FUNCTION ms_appl_data.trig_b_iu_supp_groups_validate_parent_group_type_item()
    OWNER TO <%= ms_owner %>;

REVOKE EXECUTE ON FUNCTION ms_appl_data.trig_b_iu_supp_groups_validate_parent_group_type_item() FROM public;
GRANT EXECUTE ON FUNCTION ms_appl_data.trig_b_iu_supp_groups_validate_parent_group_type_item() TO <%= ms_owner %>;

COMMENT ON FUNCTION ms_appl_data.trig_b_iu_supp_groups_validate_parent_group_type_item() IS
