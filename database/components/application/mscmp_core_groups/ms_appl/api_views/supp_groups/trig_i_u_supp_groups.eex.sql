CREATE OR REPLACE FUNCTION ms_appl.trig_i_u_supp_groups()
RETURNS trigger AS
$BODY$

-- File:        trig_i_u_supp_groups.eex.sql
-- Location:    musebms/database/components/application/mscmp_core_groups/ms_appl/api_views/supp_groups/trig_i_u_supp_groups.eex.sql
...
BEGIN
        ...
        RAISE EXCEPTION
            USING
                ...
                DETAIL = ms_syst_priv.get_exception_details(
                            ...
                            ,p_proc_name      => 'trig_i_u_supp_groups'
    ...
    UPDATE ms_appl_data.supp_groups
    SET
...
ALTER FUNCTION ms_appl.trig_i_u_supp_groups()
    OWNER TO <%= ms_owner %>;

REVOKE EXECUTE ON FUNCTION ms_appl.trig_i_u_supp_groups() FROM public;
GRANT EXECUTE ON FUNCTION ms_appl.trig_i_u_supp_groups() TO <%= ms_owner %>;

COMMENT ON FUNCTION ms_appl.trig_i_u_supp_groups() IS
$DOC$An INSTEAD OF trigger function which applies business rules when using the
supp_groups API View for UPDATE operations.$DOC$;
