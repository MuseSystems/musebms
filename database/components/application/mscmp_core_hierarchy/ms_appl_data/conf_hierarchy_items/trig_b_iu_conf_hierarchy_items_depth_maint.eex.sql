CREATE OR REPLACE FUNCTION ms_appl_data.trig_b_iu_conf_hierarchy_items_depth_maint()
RETURNS trigger AS
$BODY$

-- File:        trig_b_iu_conf_hierarchy_items_depth_maint.eex.sql
-- Location:    musebms/database/components/application/mscmp_core_hierarchy/ms_appl_data/conf_hierarchy_items/trig_b_iu_conf_hierarchy_items_depth_maint.eex.sql
...
ALTER FUNCTION ms_appl_data.trig_b_iu_conf_hierarchy_items_depth_maint()
    OWNER TO <%= ms_owner %>;

REVOKE EXECUTE ON FUNCTION ms_appl_data.trig_b_iu_conf_hierarchy_items_depth_maint() FROM public;
GRANT EXECUTE ON FUNCTION ms_appl_data.trig_b_iu_conf_hierarchy_items_depth_maint() TO <%= ms_owner %>;

COMMENT ON FUNCTION ms_appl_data.trig_b_iu_conf_hierarchy_items_depth_maint() IS
