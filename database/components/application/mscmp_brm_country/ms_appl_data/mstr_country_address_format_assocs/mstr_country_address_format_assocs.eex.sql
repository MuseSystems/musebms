...
DECLARE
    ...
    v_address_format_id      ms_syst_priv.comments_config_table_column;
...
BEGIN
    ...
    v_comments_config.table_name   := 'mstr_country_address_format_assocs';
...
$DOC$Identifies the country with with the address format is being associated.$DOC$;
    ...
    v_address_format_id.column_name := 'address_format_id';
    v_address_format_id.description :=
