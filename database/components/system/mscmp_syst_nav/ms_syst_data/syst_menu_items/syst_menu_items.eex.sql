...
DECLARE
    ...
    -- Columns
    v_menu_id             ms_syst_priv.comments_config_table_column;
    v_parent_menu_item_id ms_syst_priv.comments_config_table_column;
    v_sort_order          ms_syst_priv.comments_config_table_column;
    v_submenu_menu_id     ms_syst_priv.comments_config_table_column;
    v_action_id           ms_syst_priv.comments_config_table_column;
...
BEGIN
    ...
    v_comments_config.table_name   := 'syst_menu_items';
