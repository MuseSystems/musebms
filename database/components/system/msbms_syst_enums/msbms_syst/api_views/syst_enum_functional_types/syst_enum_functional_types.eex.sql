...
-- Location:    musebms/database/components/system/msbms_syst_enums/msbms_syst/api_views/syst_enum_functional_types/syst_enum_functional_types.eex.sql
...
CREATE TRIGGER a50_trig_i_u_syst_enum_functional_types
    INSTEAD OF UPDATE ON msbms_syst.syst_enum_functional_types
    FOR EACH ROW EXECUTE PROCEDURE msbms_syst.trig_i_u_syst_enum_functional_types();

CREATE TRIGGER a50_trig_i_d_syst_enum_functional_types
    INSTEAD OF DELETE ON msbms_syst.syst_enum_functional_types
    FOR EACH ROW EXECUTE PROCEDURE msbms_syst.trig_i_d_syst_enum_functional_types();

COMMENT ON
    VIEW msbms_syst.syst_enum_functional_types IS
...
COMMENT ON
    COLUMN msbms_syst.syst_enum_functional_types.id IS
...
COMMENT ON
    COLUMN msbms_syst.syst_enum_functional_types.internal_name IS
$DOC$A candidate key useful for programmatic references to individual records.$DOC$;

COMMENT ON
    COLUMN msbms_syst.syst_enum_functional_types.display_name IS
...
COMMENT ON
    COLUMN msbms_syst.syst_enum_functional_types.syst_description IS
...
COMMENT ON
    COLUMN msbms_syst.syst_enum_functional_types.user_description IS
...
COMMENT ON
    COLUMN msbms_syst.syst_enum_functional_types.diag_timestamp_created IS
...
COMMENT ON
    COLUMN msbms_syst.syst_enum_functional_types.diag_role_created IS
$DOC$The database role which created the record.

Note that this column may not be updated via this API View.$DOC$;

COMMENT ON
    COLUMN msbms_syst.syst_enum_functional_types.diag_timestamp_modified IS
...
COMMENT ON
    COLUMN msbms_syst.syst_enum_functional_types.diag_wallclock_modified IS
...
COMMENT ON
    COLUMN msbms_syst.syst_enum_functional_types.diag_role_modified IS
$DOC$The database role which modified the record.

Note that this column may not be updated via this API View.$DOC$;

COMMENT ON
    COLUMN msbms_syst.syst_enum_functional_types.diag_row_version IS
...
COMMENT ON
    COLUMN msbms_syst.syst_enum_functional_types.diag_update_count IS
