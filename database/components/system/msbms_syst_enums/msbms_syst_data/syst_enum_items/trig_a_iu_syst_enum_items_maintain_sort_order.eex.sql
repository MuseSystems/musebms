CREATE OR REPLACE FUNCTION msbms_syst_data.trig_a_iu_syst_enum_items_maintain_sort_order()
RETURNS trigger AS
$BODY$

-- File:        trig_a_iu_syst_enum_items_maintain_sort_order.eex.sql
-- Location:    musebms/database/components/system/msbms_syst_enums/msbms_syst_data/syst_enum_items/trig_a_iu_syst_enum_items_maintain_sort_order.eex.sql
...
ALTER FUNCTION msbms_syst_data.trig_a_iu_syst_enum_items_maintain_sort_order()
    OWNER TO <%= msbms_owner %>;

REVOKE EXECUTE ON FUNCTION msbms_syst_data.trig_a_iu_syst_enum_items_maintain_sort_order() FROM public;
GRANT EXECUTE ON FUNCTION msbms_syst_data.trig_a_iu_syst_enum_items_maintain_sort_order() TO <%= msbms_owner %>;


COMMENT ON FUNCTION msbms_syst_data.trig_a_iu_syst_enum_items_maintain_sort_order() IS
