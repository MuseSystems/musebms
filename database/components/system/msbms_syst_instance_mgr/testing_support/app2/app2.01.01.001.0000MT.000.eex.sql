-- File:        app2.01.01.001.0000MT.000.eex.sql
-- Location:    musebms/database/components/system/msbms_syst_instance_mgr/testing_support/app2/app2.01.01.001.0000MT.000.eex.sql
...
$MIGRATION$
    BEGIN
            ...
            ALTER TABLE testing.test_detail OWNER TO <%= app2_owner %>;

            REVOKE ALL ON TABLE testing.test_detail FROM public;
            GRANT ALL ON TABLE testing.test_detail TO <%= app2_owner %>;
            GRANT ALL ON TABLE testing.test_detail TO <%= app2_appusr %>;
            GRANT ALL ON TABLE testing.test_detail TO <%= app2_apiusr %>;
