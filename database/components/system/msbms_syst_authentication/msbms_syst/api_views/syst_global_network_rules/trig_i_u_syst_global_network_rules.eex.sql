CREATE OR REPLACE FUNCTION msbms_syst.trig_i_u_syst_global_network_rules()
RETURNS trigger AS
$BODY$

-- File:        trig_i_u_syst_global_network_rules.eex.sql
-- Location:    musebms/database/components/system/msbms_syst_authentication/msbms_syst/api_views/syst_global_network_rules/trig_i_u_syst_global_network_rules.eex.sql
...
ALTER FUNCTION msbms_syst.trig_i_u_syst_global_network_rules()
    OWNER TO <%= msbms_owner %>;

REVOKE EXECUTE ON FUNCTION msbms_syst.trig_i_u_syst_global_network_rules() FROM public;
GRANT EXECUTE ON FUNCTION msbms_syst.trig_i_u_syst_global_network_rules() TO <%= msbms_owner %>;

COMMENT ON FUNCTION msbms_syst.trig_i_u_syst_global_network_rules() IS
