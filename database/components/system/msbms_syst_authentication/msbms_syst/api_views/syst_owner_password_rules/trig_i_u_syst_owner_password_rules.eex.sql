...
-- Location:    musebms/database/components/system/msbms_syst_authentication/msbms_syst/api_views/syst_owner_password_rules/trig_i_u_syst_owner_password_rules.eex.sql
...
BEGIN
    ...
    SET
      ...
      , disallow_known_compromised = new.disallow_known_compromised
