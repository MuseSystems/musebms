CREATE OR REPLACE FUNCTION msbms_syst_data.trig_a_iu_syst_global_network_rule_ordering()
RETURNS trigger AS
$BODY$

-- File:        trig_a_iu_syst_global_network_rule_ordering.eex.sql
-- Location:    musebms/database/components/system/msbms_syst_authentication/msbms_syst_data/syst_global_network_rules/trig_a_iu_syst_global_network_rule_ordering.eex.sql
...
ALTER FUNCTION msbms_syst_data.trig_a_iu_syst_global_network_rule_ordering()
    OWNER TO <%= msbms_owner %>;

REVOKE EXECUTE ON FUNCTION msbms_syst_data.trig_a_iu_syst_global_network_rule_ordering() FROM public;
