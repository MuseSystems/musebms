CREATE OR REPLACE FUNCTION ms_syst_data.trig_b_u_syst_hierarchies_validate_state_change()
RETURNS trigger AS
$BODY$

-- File:        trig_b_u_syst_hierarchies_validate_state_change.eex.sql
...
ALTER FUNCTION ms_syst_data.trig_b_u_syst_hierarchies_validate_state_change()
    OWNER TO <%= ms_owner %>;
