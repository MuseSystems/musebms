CREATE OR REPLACE FUNCTION ms_syst_data.trig_b_i_syst_hierarchy_items_hierarchy_prereqs()
RETURNS trigger AS
$BODY$

-- File:        trig_b_i_syst_hierarchy_items_hierarchy_prereqs.eex.sql
...
ALTER FUNCTION ms_syst_data.trig_b_i_syst_hierarchy_items_hierarchy_prereqs()
    OWNER TO <%= ms_owner %>;
