...
COMMENT ON
    VIEW ms_syst.syst_hierarchy_items IS
...
COMMENT ON
    COLUMN ms_syst.syst_hierarchy_items.id IS
...
COMMENT ON
    COLUMN ms_syst.syst_hierarchy_items.internal_name IS
...
COMMENT ON
    COLUMN ms_syst.syst_hierarchy_items.display_name IS
...
COMMENT ON
    COLUMN ms_syst.syst_hierarchy_items.external_name IS
...
COMMENT ON
    COLUMN  ms_syst.syst_hierarchy_items.hierarchy_id IS
...
COMMENT ON
    COLUMN ms_syst.syst_hierarchy_items.hierarchy_depth IS
...
COMMENT ON
    COLUMN ms_syst.syst_hierarchy_items.required IS
...
COMMENT ON
    COLUMN ms_syst.syst_hierarchy_items.allow_leaf_nodes IS
...
COMMENT ON
    COLUMN ms_syst.syst_hierarchy_items.diag_timestamp_created IS
...
COMMENT ON
    COLUMN ms_syst.syst_hierarchy_items.diag_role_created IS
$DOC$The database role which created the record.

This column is read only and not maintainable using this API view.$DOC$;

COMMENT ON
    COLUMN ms_syst.syst_hierarchy_items.diag_timestamp_modified IS
...
COMMENT ON
    COLUMN ms_syst.syst_hierarchy_items.diag_wallclock_modified IS
...
COMMENT ON
    COLUMN ms_syst.syst_hierarchy_items.diag_role_modified IS
$DOC$The database role which modified the record.

This column is read only and not maintainable using this API view.$DOC$;

COMMENT ON
    COLUMN ms_syst.syst_hierarchy_items.diag_row_version IS
...
COMMENT ON
    COLUMN ms_syst.syst_hierarchy_items.diag_update_count IS
