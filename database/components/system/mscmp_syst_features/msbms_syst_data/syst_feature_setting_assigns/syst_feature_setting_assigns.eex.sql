...
-- Location:    musebms/database/components/system/mscmp_syst_features/msbms_syst_data/syst_feature_setting_assigns/syst_feature_setting_assigns.eex.sql
...
CREATE TABLE msbms_syst_data.syst_feature_setting_assigns
(
     id
        uuid
...
ALTER TABLE msbms_syst_data.syst_feature_setting_assigns OWNER TO <%= msbms_owner %>;

REVOKE ALL ON TABLE msbms_syst_data.syst_feature_setting_assigns FROM public;
GRANT ALL ON TABLE msbms_syst_data.syst_feature_setting_assigns TO <%= msbms_owner %>;
...
COMMENT ON
    COLUMN msbms_syst_data.syst_feature_setting_assigns.id IS
$DOC$The record's primary key.  The definitive identifier of the record in the
system.$DOC$;

COMMENT ON
    COLUMN msbms_syst_data.syst_feature_setting_assigns.feature_map_id IS
$DOC$Identifies the feature mapping record to which the relation record is being
associated.$DOC$;

COMMENT ON
    COLUMN msbms_syst_data.syst_feature_setting_assigns.setting_id IS
$DOC$Identifies the settings record which is being associated with the feature.$DOC$;

COMMENT ON
    COLUMN msbms_syst_data.syst_feature_setting_assigns.diag_timestamp_created IS
$DOC$The database server date/time when the transaction which created the record
started.$DOC$;

COMMENT ON
    COLUMN msbms_syst_data.syst_feature_setting_assigns.diag_role_created IS
$DOC$The database role which created the record.$DOC$;

COMMENT ON
    COLUMN msbms_syst_data.syst_feature_setting_assigns.diag_timestamp_modified IS
$DOC$The database server date/time when the transaction which modified the record
started.  This field will be the same as diag_timestamp_created for inserted
records.$DOC$;

COMMENT ON
    COLUMN msbms_syst_data.syst_feature_setting_assigns.diag_wallclock_modified IS
$DOC$The database server date/time at the moment the record was actually modified.
For long running transactions this time may be significantly later than the
value of diag_timestamp_modified.$DOC$;

COMMENT ON
    COLUMN msbms_syst_data.syst_feature_setting_assigns.diag_role_modified IS
$DOC$The database role which modified the record.$DOC$;

COMMENT ON
    COLUMN msbms_syst_data.syst_feature_setting_assigns.diag_row_version IS
...
COMMENT ON
    COLUMN msbms_syst_data.syst_feature_setting_assigns.diag_update_count IS
