CREATE OR REPLACE FUNCTION ms_syst_data.trig_b_iu_syst_group_type_items_depth_maint()
RETURNS trigger AS
$BODY$

-- File:        trig_b_iu_syst_group_type_items_depth_maint.eex.sql
-- Location:    musebms/database/components/system/mscmp_syst_groups/ms_syst_data/syst_group_type_items/trig_b_iu_syst_group_type_items_depth_maint.eex.sql
...
ALTER FUNCTION ms_syst_data.trig_b_iu_syst_group_type_items_depth_maint()
    OWNER TO <%= ms_owner %>;

REVOKE EXECUTE ON FUNCTION ms_syst_data.trig_b_iu_syst_group_type_items_depth_maint() FROM public;
GRANT EXECUTE ON FUNCTION ms_syst_data.trig_b_iu_syst_group_type_items_depth_maint() TO <%= ms_owner %>;

COMMENT ON FUNCTION ms_syst_data.trig_b_iu_syst_group_type_items_depth_maint() IS
