...
-- Location:    musebms/database/components/system/msbms_syst_numberings/msbms_syst_data/syst_numbering_sequences/syst_numbering_sequences.eex.sql
...
CREATE TRIGGER a50_trig_a_i_syst_numbering_sequence_create_value
    ...
    FOR EACH ROW EXECUTE PROCEDURE msbms_syst_data.trig_a_i_syst_numbering_sequence_create_value();
