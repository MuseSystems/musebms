CREATE OR REPLACE FUNCTION ms_syst.trig_i_u_syst_perm_types()
RETURNS trigger AS
$BODY$

-- File:        trig_i_u_syst_perm_types.eex.sql
-- Location:    musebms/database/components/system/mscmp_syst_perms/ms_syst/api_views/syst_perm_types/trig_i_u_syst_perm_types.eex.sql
...
BEGIN
    ...
    UPDATE ms_syst_data.syst_perm_types
    SET
...
syst_perm_types API View for UPDATE operations.$DOC$;
