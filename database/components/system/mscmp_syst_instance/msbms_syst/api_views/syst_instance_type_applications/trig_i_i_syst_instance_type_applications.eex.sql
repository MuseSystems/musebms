...
-- Location:    musebms/database/components/system/mscmp_syst_instance/msbms_syst/api_views/syst_instance_type_applications/trig_i_i_syst_instance_type_applications.eex.sql
