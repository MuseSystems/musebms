...
-- Location:    musebms/database/components/system/mscmp_syst_instance/msbms_syst_data/syst_instance_type_applications/trig_a_i_syst_instance_type_apps_create_inst_type_contexts.eex.sql
