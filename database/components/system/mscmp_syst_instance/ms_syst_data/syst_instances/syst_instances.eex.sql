...
BEGIN
    ...
    v_comments_config.table_name   := 'syst_instances';
...
instances.$DOC$;
    ...
    v_owning_instance_id.description :=
...
bad credentials; there may be other consequences as well.$DOC$;
    ...
    v_instance_options.description :=
