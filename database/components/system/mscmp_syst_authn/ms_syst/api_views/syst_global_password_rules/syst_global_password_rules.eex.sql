...
BEGIN
    ...
    v_view_config.table_name      := 'syst_global_password_rules';
    v_view_config.view_schema     := 'ms_syst';
    v_view_config.view_name       := 'syst_global_password_rules';
