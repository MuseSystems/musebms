...
DECLARE
    ...
    -- Columns
    v_password_hash ms_syst_priv.comments_config_table_column;
...
BEGIN
    ...
    v_comments_config.table_name      := 'syst_disallowed_passwords';
    v_comments_config.generate_common := FALSE;
...
also get some reasonable obscuring of possibly private data.$DOC$;
    ...
    v_comments_config.columns :=
        ARRAY [ v_password_hash ]::ms_syst_priv.comments_config_table_column[];
