...
# Location:    musebms/components/system/mscmp_syst_enums/lib/runtime/server.ex
...
defmodule MscmpSystEnums.Runtime.Server do
  ...
  @spec start_link(MscmpSystEnums.Types.enum_service_params()) ::
  ...
  @impl true
  @spec init(MscmpSystEnums.Types.enum_service_params()) ::
