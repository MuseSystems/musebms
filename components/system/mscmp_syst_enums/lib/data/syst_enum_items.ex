...
# Location:    musebms/components/system/mscmp_syst_enums/lib/data/syst_enum_items.ex
...
defmodule MscmpSystEnums.Data.SystEnumItems do
  ...
  @type t() ::
          %__MODULE__{
            ...
            enum: MscmpSystEnums.Data.SystEnums.t() | Ecto.Association.NotLoaded.t() | nil,
            functional_type_id: Ecto.UUID.t() | nil,
            functional_type:
              MscmpSystEnums.Data.SystEnumFunctionalTypes.t()
  ...
  schema "syst_enum_items" do
    ...
    belongs_to(:enum, MscmpSystEnums.Data.SystEnums)
    belongs_to(:functional_type, MscmpSystEnums.Data.SystEnumFunctionalTypes)
  end
