...
# Location:    musebms/components/system/mscmp_syst_enums/lib/data/syst_enums.ex
...
defmodule MscmpSystEnums.Data.SystEnums do
  ...
  @type t() ::
          %__MODULE__{
            ...
            functional_types:
              list(MscmpSystEnums.Data.SystEnumFunctionalTypes.t())
              | Ecto.Association.NotLoaded.t()
              | nil,
            enum_items:
              list(MscmpSystEnums.Data.SystEnumItems.t()) | Ecto.Association.NotLoaded.t() | nil,
  ...
  schema "syst_enums" do
    ...
    has_many(:functional_types, MscmpSystEnums.Data.SystEnumFunctionalTypes, foreign_key: :enum_id)

    has_many(:enum_items, MscmpSystEnums.Data.SystEnumItems, foreign_key: :enum_id)
  end
