...
# Location:    musebms/components/system/msbms_syst_authentication/lib/data/syst_global_password_rules.ex
...
defmodule MsbmsSystAuthentication.Data.SystGlobalPasswordRules do
