...
# Location:    musebms/components/system/mscmp_syst_db/lib/db_types/impl/date_range.ex
...
defimpl MscmpSystDb.DbTypes, for: MscmpSystDb.DbTypes.DateRange do
  alias MscmpSystDb.DbTypes.Impl.DateRange
...
defmodule MscmpSystDb.DbTypes.Impl.DateRange do
