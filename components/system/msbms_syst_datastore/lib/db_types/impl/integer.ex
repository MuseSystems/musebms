...
# Location:    musebms/components/system/msbms_syst_datastore/lib/db_types/impl/integer.ex
...
# The implementation of MsbmsSystDatastore.DbTypes for Integer is being done to
