...
# Location:    musebms/components/system/mscmp_syst_instance/lib/msdata/syst_owners.ex
...
defmodule Msdata.SystOwners do
  ...
  defdelegate insert_changeset(insert_params, opts \\ []), to: Validators.SystOwners
