...
# Location:    musebms/components/system/msbms_syst_settings/test/test_helper.exs
...
settings_service_spec = %{
  id: MsbmsSystSettingsTestingService,
  start: {
    MsbmsSystSettings,
    :start_link,
...
children = [
  {DynamicSupervisor, strategy: :one_for_one, name: MsbmsSystSettings.TestingSupervisor}
]
...
DynamicSupervisor.start_child(MsbmsSystSettings.TestingSupervisor, settings_service_spec)
