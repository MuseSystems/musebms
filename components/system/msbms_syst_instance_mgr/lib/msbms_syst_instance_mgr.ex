defmodule MsbmsSystInstanceMgr do
  ...
  ## Parameters
    ...
    * `instance_type_context` - this value may either be the record ID of the
    ...
    `MsbmsSystInstanceMgr.Data.SystInstanceTypeContexts` struct representing the
    target record.
  ...
  ## Parameters
    ...
    * `owner` - This value must either by the record ID of an existing Owner
    record or the `MsbmsSystInstanceMgr.Data.SystOwners` struct representing an
    existing owner.
  ...
  ## Parameters
    ...
    * `instance` - the instance parameter is either the record ID value of the
    Instance record desired or the `MsbmsSystInstanceMgr.Data.SystInstances`
  ...
  ## Parameters
    ...
    * `instance` - the current `MsbmsSystInstanceMgr.Data.SystInstances` struct
  ...
  `MsbmsSystInstanceMgr.Data.SystInstances` records from the database.
  ...
  ## Parameters
    ...
    * `application` - either the record ID or the
    `MsbmsSystInstanceMgr.Data.SystApplications` struct representing the
  ...
  ## Parameters
    ...
    * `instance` - either the record ID or the
    `MsbmsSystInstanceMgr.Data.SystInstances` struct of the Instance to stop.
