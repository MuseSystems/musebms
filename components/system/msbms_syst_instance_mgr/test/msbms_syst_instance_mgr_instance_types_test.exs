# Source File: msbms_syst_instance_mgr_instance_types_test.exs
# Location:    components/system/msbms_syst_instance_mgr/test/msbms_syst_instance_mgr_instance_types_test.exs
# Project:     msbms
#
...
defmodule MsbmsSystInstanceMgrInstanceTypesTest do
