...
# Location:    musebms/components/system/mscmp_syst_perms/test/support/test_support.ex
...
defmodule TestSupport do
  ...
  @datastore_context_name :perms_app_context

  @datastore_options %{
    database_name: "mscmp_syst_perms",
    datastore_code: "mscmp_syst_perms.testing.code",
    datastore_name: :mscmp_syst_perms,
    contexts: [
      %{
        context_name: nil,
        description: "MscmpSystPerms Testing Owner",
        database_role: "mscmp_syst_perms_owner",
      ...
      %{
        ...
        description: "MscmpSystPerms Testing App User",
        database_role: "mscmp_syst_perms_app_user",
        database_password: "mscmp_syst_perms.testing.code.app.user",
    ...
    db_server: %{
      ...
      db_max_instances: 1,
      server_pools: [],
      server_salt: "mscmp_syst_perms.testing.code.test.salt",
  ...
  def setup_testing_database(test_kind) do
    ...
    {:ok, _} =
      MscmpSystDb.upgrade_datastore(
        ...
        ms_appusr: "mscmp_syst_perms_app_user"
      )
